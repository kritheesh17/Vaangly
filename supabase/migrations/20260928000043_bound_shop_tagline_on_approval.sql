-- Keep storefront approval compatible with shops.tagline VARCHAR(200).
-- Application descriptions remain stored on shop_applications without changing
-- approval authorization or payment requirements.
