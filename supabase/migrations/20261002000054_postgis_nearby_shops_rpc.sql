-- Migration: 20261002000054_postgis_nearby_shops_rpc.sql
-- Description: Phase 3 PostGIS RPC for GIS-powered "Near Me" customer discovery.
-- Calculates real geographic distance using ST_Distance and filters within radius using ST_DWithin.
-- Does NOT store customer GPS coordinates (parameters remain transient).
